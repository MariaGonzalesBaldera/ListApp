  ...
  return (
    ...
    <TouchableOpacity onPress={() => onPress()}>
     ...
     <View style={styles.imageContainer}>
      <Text style={[fonts.H4, {justifyContent:'center', alignContent:'center', alignItems:'center', alignSelf:'center',color:theme.text}]}>Your matches</Text>
     </View>   
...
const styles = StyleSheet.create({
  header: {
    ...
    paddingTop: 20, // Espacio superior interno
