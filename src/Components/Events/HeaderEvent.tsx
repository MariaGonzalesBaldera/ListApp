...
import { ArrowLeft, Close, Lupa } from '../../../Assets/svg';
  ...
  return (
    ...
    <TouchableOpacity onPress={() => onPress()}>
     ...
     <View style={styles.imageContainer}>
      <Text style={[fonts.H4, {justifyContent:'center', alignContent:'center', alignItems:'center', alignSelf:'center', color: colors.neutral.darkest}]}>Older Chats</Text>
     </View>   
...
const styles = StyleSheet.create({
  header: {
    ...
    backgroundColor: colors.neutral.white, // Color de fondo del encabezado
  },
  imageContainer: {
