...
export default function Filters() {
  ...
  const [range, setRange] = useState([
    formProfile.rangeStart,
    formProfile.rangeEnd,
  ]);
  ...
  const [notRepeat, setNotRepeat] = useState(true);
  useEffect(() => {
    fetchMusic();
    fetchHealth();
    fetchSocial();
  ...
  const clearForm = async () => {
    const selectedValues = {
      ...
      to_price: '',
      range: '',
      music: musics.reduce((acc, music) => {
        acc[music.name] = false;
        return acc;
      }, {}),
      sport: sports.reduce((acc, sport) => {
        acc[sport.name] = false;
        return acc;
      }, {}),
      social: socials.reduce((acc, social) => {
        acc[social.name] = false;
        return acc;
      }, {}),
      community: communitys.reduce((acc, community) => {
        acc[community.name] = false;
        return acc;
      }, {}),
      health: healths.reduce((acc, health) => {
        acc[health.name] = false;
        return acc;
      }, {}),
      seasonal: seasonals.reduce((acc, seasonal) => {
        acc[seasonal.name] = false;
        return acc;
      }, {}),
    };
    ...
    await AsyncStorage.setItem('@eventFilter', JSON.stringify(updatedValues));
  };
        ...
        <ScrollView
          ...
          <TouchableOpacity
            ...
            <View
              ...
              {checked && <Checked color={colors.neutral.white} />}
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <View
              ...
              {checked2 && <Checked color={colors.neutral.white} />}
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <View
              ...
              {checked3 && <Checked color={colors.neutral.white} />}
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <View
              ...
              {checked4 && <Checked color={colors.neutral.white} />}
            </View>
          </TouchableOpacity>
              ...
              {musics.map((music: EventType, index) => (
                <TouchableOpacity
                  ...
                  <View
                    ...
                    {music.checked && <Checked color={colors.neutral.white} />}
                  </View>
                </TouchableOpacity>
              ))}
              ...
              {sports.map((sport: EventType, index) => (
                <TouchableOpacity
                  ...
                  <View
                    ...
                    {sport.checked && <Checked color={colors.neutral.white} />}
                  </View>
                </TouchableOpacity>
              ))}
              ...
              {socials.map((social: EventType, index) => (
                <TouchableOpacity
                  ...
                  <View
                    ...
                    {social.checked && <Checked color={colors.neutral.white} />}
                  </View>
                </TouchableOpacity>
              ))}
              ...
              {communitys.map((community: EventType, index) => (
                <TouchableOpacity
                  ...
                  <View
                    ...
                    {community.checked && <Checked color={colors.neutral.white} />}
                  </View>
                </TouchableOpacity>
              ))}
              ...
              {healths.map((health: EventType, index) => (
                <TouchableOpacity
                  ...
                  <View
                    ...
                    {health.checked && <Checked color={colors.neutral.white} />}
                  </View>
                </TouchableOpacity>
              ))}
              ...
              {seasonals.map((seasonal: EventType, index) => (
                <TouchableOpacity
                  ...
                  <View
                    ...
                    {seasonal.checked && <Checked color={colors.neutral.white} />}
                  </View>
                </TouchableOpacity>
              ))}
            </>
